...
//
//	mockgen -source=querier.go -destination=mocks/querier_mock.go
//
...
// ListContentsWithCategories mocks base method.
func (m *MockQuerier) ListContentsWithCategories(ctx context.Context) ([]persistence.PostView, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListContentsWithCategories", ctx)
	ret0, _ := ret[0].([]persistence.PostView)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListContentsWithCategories indicates an expected call of ListContentsWithCategories.
func (mr *MockQuerierMockRecorder) ListContentsWithCategories(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListContentsWithCategories", reflect.TypeOf((*MockQuerier)(nil).ListContentsWithCategories), ctx)
}
