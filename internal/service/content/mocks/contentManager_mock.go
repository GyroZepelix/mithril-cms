...
// Source: contentManager.go
//
// Generated by this command:
//
//	mockgen -source=contentManager.go -destination=mocks/contentManager_mock.go
//
...
func (m *MockManager) CreateContent(title, content string, userId uuid.UUID, ctx context.Context) (*persistence.Post, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateContent", title, content, userId, ctx)
...
func (mr *MockManagerMockRecorder) CreateContent(title, content, userId, ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateContent", reflect.TypeOf((*MockManager)(nil).CreateContent), title, content, userId, ctx)
}
...
func (m *MockManager) ListContents(ctx context.Context) ([]persistence.PostView, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListContents", ctx)
	ret0, _ := ret[0].([]persistence.PostView)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
